...
nasm src\sector2+\binaries.asm -f elf64 -o bin\binaries.o
nasm src\sector2+\MainProg.asm -f elf64 -o bin\main_prog.o

wsl %WSLPATH%/x86_64-elf-g++ -Ttext 0x8000 -ffreestanding -mno-red-zone -m64 -c "src/kernel/Kernel.cpp" -o "bin/kernel.o"
